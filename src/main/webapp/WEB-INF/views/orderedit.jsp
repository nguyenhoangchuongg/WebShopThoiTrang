...
<body>
	...
	<div class="card" style="padding-left: 300px">
		<div class="card-body">
			...
			<form:form action="/admin/orderedit" modelAttribute="item">
				<div style="padding-left: 00px;">
					<form:input path="id" id="input" type="text"
						autocomplete="off" name="text" class="input"
						placeholder="ID" />
					<form:input path="account.username" id="input" type="text"
						autocomplete="off" name="text" class="input"
						placeholder="Name" />
					...
					<form:input path="address" id="input" type="text" autocomplete="off"
						name="text" class="input" placeholder="Address" />
		...
		<div style="padding-left: 275px;">
			...
			<button class="click" formaction="/admin/order/delete/${username}">Delete</button>
