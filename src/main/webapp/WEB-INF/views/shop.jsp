				...
				<div class="col-lg-3">
					<div class="shop__sidebar">
						<div class="shop__sidebar__search">
							<form action="/index/search-name" method="get">
								<input type="text" placeholder="Search..." name="keyword" value="${keyword}">
								<button type="submit">
									<a href="/index/search-name"><span class="icon_search"></span></a>
								</button>
							</form>
						</div>
											...
											<div class="shop__sidebar__categories">
												...
												<ul class="nice-scroll">
													<c:forEach var="cate" items="${categories}">
														<li><a href="#">${cate.name} (${cate.count})</a></li>
													</c:forEach>
												</ul>
											</div>
										</div>
						...
						<div class="row">
							<div class="col-lg-6 col-md-6 col-sm-6">
								<div class="shop__product__option__left">
									...
									<p>Showing 1–6 of ${allpr}  results</p>
							...
							<div class="col-lg-4 col-md-6 col-sm-6">
								<div class="product__item">
									<div class="product__item__pic set-bg"
										data-setbg="/img/product/${p.image}">
									...
									<div class="product__item__text">
										<h6>${p.name}</h6>
										<a href="/index/shop/detail/${p.id}" class="add-cart">+
											Add To Cart</a>
										<div class="rating">
					...
					<div class="row">
						<div class="col-lg-12">
							<div class="product__pagination">
								<a href="/index/shop-page?p=0">F  </a> <a
									href="/index/shop-page?p=${page.number+1}">N   </a> <a
									href="/index/shop-page?p=${page.number-1}">Pre</a>
								<a href="/index/shop-page?p=${page.totalPages-1}">L   </a>
							</div>
						</div>
					</div>
