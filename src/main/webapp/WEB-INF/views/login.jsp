	...
	<div class="container" id="container">
		<div class="form-container sign-up-container">
			<form action="/resignter" method="post">
				...
				<input type="text" placeholder="Username" name="createuser" /> 
				<input type="text" placeholder="Fullname" name="createname"  />
				<input type="email" placeholder="Email" name="createemail" />
				<input type="password" placeholder="Password" name="createpass" />
